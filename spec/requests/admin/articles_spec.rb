...
RSpec.describe "/admin/articles", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Admin::Article.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Admin::Article" do
        expect {
          post admin_articles_url, params: { admin_article: valid_attributes }
        }.to change(Admin::Article, :count).by(1)
      end

      it "redirects to the created admin_article" do
        post admin_articles_url, params: { admin_article: valid_attributes }
        expect(response).to redirect_to(admin_article_url(Admin::Article.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Admin::Article" do
        expect {
          post admin_articles_url, params: { admin_article: invalid_attributes }
        }.to change(Admin::Article, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested admin_article" do
        article = Admin::Article.create! valid_attributes
        patch admin_article_url(article), params: { admin_article: new_attributes }
        article.reload
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        article = Admin::Article.create! valid_attributes
        patch admin_article_url(article), params: { admin_article: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_content)
      end
    end
  end
